...
<details>
  <summary><strong>Выходные данные:</strong>На выход подаются все поля заказа, какими они сохранились, так как не вся информация обязательная в запросе:</summary>
  <p>
```json
{
    "id": 1,
